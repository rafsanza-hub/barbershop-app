...
<section class="section">
    ...
    <div class="section-body">
        ...
        <p class="section-lead">Here you can view and manage the Admin data.</p>
        <div class="row">
            <div class="col-12">
                <!-- Card Component -->
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-form">
                            <a href="<?= base_url( 'admin/create') ?>" class="btn btn-primary">Tambah Admin</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($admins as $admin) : ?>
                                        <tr>
                                            ...
                                            <td><?= $admin['email'] ?></td>
                                            <td><?= $admin['active'] == 1 ? 'Active' : 'Non Active' ?></td>
                                            <td>
                                                ...
                                                <a href="<?= base_url('admin/edit/' . $admin['id']) ?>" class="btn btn-secondary btn-sm btn-edit">Edit</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
